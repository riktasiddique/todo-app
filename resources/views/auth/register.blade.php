                ...
                <div class="col-md-4 mt-5">
                    ...
                    <form class="login-form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="name" type="text" class="bg-dark w-100 text-white-50" placeholder="Name" value="{{old('name')}}">
                          </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Password</label>
                            <input name="password_confirmation" type="password" class="bg-dark w-100 text-white-50" placeholder="Password">
                          </div>
                        ...
                        <div class="d-grid gap-2">
                            <button class="btn btn-light" type="submit">Sing Up</button>
                          </div>
                    </form>
                    <div class="mt-2">
                        <h6 class="text-white text-center">Already have an account? <a href="{{ route('login') }}">Log in</a></h6>
                    </div>
                </div>
            </div>
        </section>
