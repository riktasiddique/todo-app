...
<html lang="en">
    ...
    <link rel="stylesheet" href="{{asset('assets/to-do/ui/css/font-awesome.min.css')}}" />
    <link rel="stylesheet" href="{{asset('assets/to-do/ui/css/bootstrap.min.css')}}" />
    <link rel="stylesheet" href="{{asset('assets/to-do/ui/css/style.css')}}" />
    </head>
    <body>
